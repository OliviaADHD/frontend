...
const Tutorial5Content = ({navigation}) => {
    ...
    return(
        <StyledContainer style={{backgroundColor: Colors.gray}}>
                ...
                <Background source={require('../../assets/images/GetStartedBackground.png')}
                    ...
                    <View style={styles.PurpleBubble}>
                        <Text style={styles.BubbleText}>
                            Get connected to the people and share thoughts here.
                        </Text>
                    </View>
                </Background>
                <DashboardTutorialBottomBar>
                <TouchableOpacity onPress={() => {navigation.navigate("Tutorial6")}}
            ...
            <DashBoardBottomMenuStatic currentScreen={"Awareness"} backgroundColor={true}/>
        </StyledContainer>
    )
};
...
const Tutorial5 = ({navigation}) => {
    return (
        <Provider store={store}>
         <Tutorial5Content navigation={navigation}/>
        </Provider>
